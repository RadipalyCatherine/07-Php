...
<!-- 
     ...
     <label for="categorie"></label>
        ...
        placeholder="Saisissez votre catégorie"><br>

    <label for="radio"></label>
        <input type="button" id="Offre"><br> 
        <input type="button" id="Demande"><br>
    ...
    <label for="textarea"></label>
        <input type="text"
    placeholder="Saisissez votre texte"><br>

    <label for="textarea"></label>
        <input type="text"
    placeholder="text de l'annonce"><br>

    <label for="text"></label>
        <input type="text"
    placeholder="prix de l'annonce"><br>
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control"
                                name="titre" placeholder="Titre de l'annonce...">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="prix"
                                class="form-control" placeholder="Prix de l'annonce...">
...
<!-- 
     ...
     <?php
        ...
        $categorie = $type = $titre = $annonce = $prix = $content = null;
